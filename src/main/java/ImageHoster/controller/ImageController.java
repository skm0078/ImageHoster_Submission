...
public class ImageController {
    ...
    // Here a list of tags is added in the Model type object this list is then sent to 'images/image.html' file and the tags are displayed
    ...
    // Store all the tags in the database and make a list of all the tags using the findOrCreateTags() method set the tags attribute of the image as a list of all the tags returned by the findOrCreateTags() method
    ...
    // findOrCreateTags() method and sets the tags attribute of an image as a list of all the tags
    ...
    // findOrCreateTags() method has been implemented, which returns the list of tags after converting the ‘tags’ string to a list of all the tags and also stores the tags in the database if they do not exist in the database. Observe
    // the method and complete the code where required for this method.
    // Try to get the tag from the database using getTagByName() method. If tag is returned, you need not to store that tag in the database, and if null is
    // returned, you need to first store that tag in the database and then the tag is added to a list
    ...
    // The method receives the list of all tags Converts the list of all tags to a single string containing all the tags separated by a comma Returns the string
